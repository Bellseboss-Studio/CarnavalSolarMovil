...
public class MediadorDeEstadosDelJuegoOffline : MonoBehaviour, IMediadorDeEstadosDelJuego
{
    ...
    [SerializeField] private ColocacionCartasOffline _colocacionCartas;
    ...
    private bool _seColocoElHeroe = false, _seColocoElHeroeEnemigo = true;
    ...
    private void Start()
    {
        ...
        _configuracionDeLosEstadosDelJuego.AddInitialState(ConfiguracionDeLosEstadosDelJuego.ConfiguracionDelJuego,
            new ConfiguracionDelJuegoStateOffline(this, _factoriaCarta, _colocacionCartas, cartasConfiguracion, canvasPrincipal, _factoriaPersonaje, canvasDeLasCartas, _transformDondePosicionar));
